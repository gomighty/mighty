...
class MightyStartCommand extends Command
{
    /** @var string */
    protected $signature = 'mighty:start {--port= : Sidecar port} {--runtime= : bun or node}';

    /** @var string */
    protected $description = 'Start the Mighty sidecar in production mode';
    ...
    public function handle(): int
    {
        ...
        $process = new Process([$runner, 'mighty-sidecar', 'start', '--port', (string) $port, '--root', $root], base_path());
